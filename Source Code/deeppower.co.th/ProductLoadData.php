...
$sql = "select count(*) as ItemCount from product" . $sqlCondition . " ";
$itemsCount = SelectRow($sql, $values);

$sql = "select * from product " . $sqlCondition . " order by SEQ,ProductCode limit $sItems,$limitPage ";
            ...
            <a href="<?php echo $_URL; ?>" class="roomCard -type-2 -hover-button-center">
                ...
                <div class="roomCard__content mt-30">
                    <div class="d-flex justify-between items-end">
                        <h3 class="roomCard__title lh-065 text-40 md:text-24"><?php echo $data["ProductName"]; ?></h3>
                    </div>
