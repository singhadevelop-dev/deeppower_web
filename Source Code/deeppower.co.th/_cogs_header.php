...
<meta property="og:image" content="<?php echo !empty($_CURRENT_PAGE_HEADER["IMAGE"]) ? $_CURRENT_PAGE_HEADER["IMAGE"] : $_Util_WebsitDetail["Image3"] ?>">
...
<link rel="icon" href="<?php echo !empty($_CURRENT_PAGE_HEADER["IMAGE"]) ? $_CURRENT_PAGE_HEADER["IMAGE"] : $_Util_WebsitDetail["Image3"] ?>" />
<link rel="shortcut icon" href="<?php echo !empty($_CURRENT_PAGE_HEADER["IMAGE"]) ? $_CURRENT_PAGE_HEADER["IMAGE"] : $_Util_WebsitDetail["Image3"] ?>">
<link rel="apple-touch-icon" href="<?php echo !empty($_CURRENT_PAGE_HEADER["IMAGE"]) ? $_CURRENT_PAGE_HEADER["IMAGE"] : $_Util_WebsitDetail["Image3"] ?>">
<link rel="apple-touch-icon" sizes="72x72" href="<?php echo !empty($_CURRENT_PAGE_HEADER["IMAGE"]) ? $_CURRENT_PAGE_HEADER["IMAGE"] : $_Util_WebsitDetail["Image3"] ?>">
<link rel="apple-touch-icon" sizes="114x114" href="<?php echo !empty($_CURRENT_PAGE_HEADER["IMAGE"]) ? $_CURRENT_PAGE_HEADER["IMAGE"] : $_Util_WebsitDetail["Image3"] ?>">
<link rel="canonical" href="<?php echo $_SERVER['REQUEST_SCHEME'] . "://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'] ?>" />
...
<style>
    ...
    .panel-content-htmleditor table,
    .panel-content-htmleditor tbody,
    .panel-content-htmleditor tr,
    .panel-content-htmleditor td,
    .panel-content-htmleditor th {
