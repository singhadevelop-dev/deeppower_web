...
if (isset($_POST["btnSave"])) {
    ...
    // https://career.sonepar.com/go/thailanden/4995201/
    
    for ($i = 0; $i < countval($PageCode); $i++) {
        $_PageURLName = strpos($PageURLName[$i],"://") !== false ? $PageURLName[$i] : SanitizeURL($PageURLName[$i],true);
