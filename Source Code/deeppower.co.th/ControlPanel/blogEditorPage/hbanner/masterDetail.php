...
if (isset($_POST["btnSave"])) {
    ...
    $uploadFileTargetDetail =  $GLOBALS["ROOT"] . "/_content_images/" . GetCurrentLang() . "/" . strtolower($_COG_ITEM_CODE) . "/";
    ...
    $txtDetail3 = $_COG_ALLOW_MASTER_HTML_EDITOR3 ? GeneratePageFile($_POST["txtDetailHTML3"], $keyRefCode . "-3") : "";

    $dataOld =  SelectRow("select PortType from portfolio where PortType=:portType ", array('portType' => $keyRefCode));
    if ($dataOld !== false) {
        ...
        $sqlUpdate = "insert into portfolio (PortCode,PortName,PortDetail,PortHtml2,PortHtml3,Image,Image2,Image3,Video,Video2,FileDownload,FileDownloadName,Active,CreatedOn,CreatedBy,PortType,ShortDescription,PortDetail1,Year,ByName)
            VALUES(
                '$portCode',
                '$txtSubject',
                '$txtDetail',
...
$sql = "select * from portfolio where PortType= :PortType limit 1";
$data = SelectRow($sql, array('PortType' => $keyRefCode));
        ...
        <div class="col-md-<?php echo $_COG_ALLOW_LEFT_MENU ? "10" : "12" ?>">
            <form method="post" enctype="multipart/form-data">
                    ...
                    <?php if ($_COG_ALLOW_MASTER_GALLERY) { ?>
                        <div class="col-md-6">
                            <div>
                                ...
                                <hr style="margin-top: 5px; margin-bottom: 5px;" />
                                <p>
                                    <?php $image_size = !empty($_COG_ALLOW_MASTER_GALLERY_SIZE) ? $_COG_ALLOW_MASTER_GALLERY_SIZE : "1200x900" ?>
                    ...
                    <?php if ($_COG_ALLOW_MASTER_GALLERY2) { ?>
                        <div class="col-md-6">
                            <div>
                                ...
                                <hr style="margin-top: 5px; margin-bottom: 5px;" />
                                <p>
                                    <?php $image_size2 = !empty($_COG_ALLOW_MASTER_GALLERY_SIZE2) ? $_COG_ALLOW_MASTER_GALLERY_SIZE2 : "1200x900" ?>
                    ...
                    <?php if ($_COG_ALLOW_MASTER_GALLERY3) { ?>
                        <div class="col-md-6">
                            <div>
                                ...
                                <hr style="margin-top: 5px; margin-bottom: 5px;" />
                                <p>
                                    <?php $image_size3 = !empty($_COG_ALLOW_MASTER_GALLERY_SIZE3) ? $_COG_ALLOW_MASTER_GALLERY_SIZE3 : "1200x900" ?>
                ...
                <?php if ($_COG_ALLOW_MASTER_TITLE || $_COG_ALLOW_MASTER_YEAR) { ?>
                    <div class="row">
                        ...
                        <?php if ($_COG_ALLOW_MASTER_YEAR) { ?>
                            <div class="col-sm-4">
                                <label>หัวข้อพื้นหลังเขียว<?php echo $_COG_ITEM_NAME ?></label>
                                <input type="text" placeholder="หัวข้อพื้นหลังเขียว<?php echo $_COG_ITEM_NAME ?>..." name="txtYear" id="txtYear" value="<?php echo $data["Year"] ?>" class="form-control input-sm require" />
                            </div>
                        <?php } ?>
                    </div>
                <?php } ?>
                <?php if ($_COG_ALLOW_MASTER_AUTHOR) { ?>
                    <div class="row">
                        <div class="col-sm-12">
                            <label>หัวข้อ 3</label>
                            <input type="text" placeholder="หัวข้อ 3..." name="txtByName" id="txtByName" value="<?php echo $data["ByName"] ?>" class="form-control input-sm require" />
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php if ($_COG_ALLOW_MASTER_HTML_EDITOR3) { ?>
                    <hr style="margin-top: 5px;" />
