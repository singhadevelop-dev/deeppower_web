...
<?php
    ...
    $data = SelectRow($sql, array('reviewCode' => $reviewCode));
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    ...
                    <div id="imge-preview-<?php echo $data["ReviewCode"] ?>" class="image-box hand"
                        ...
                        style="width: 100%; height: 150px;margin-bottom:5px; background-image: url(<?php echo $data["Image"] ?>), url('https://via.placeholder.com/88x85')">
                    </div>
            ...
            <div class="row hide">
                <div class="col-12">
                    <input type="text" name="txtReviewPosition" value="<?php echo $data["Position"]; ?>"
                        class="form-control inpu-lg" placeholder="ตำแหน่ง">
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <textarea name="txtReviewMessage" rows="3" class="form-control"
