...
if(isset($_POST["btnDeleteRow"])){
    $sqlDelete = "delete from review where ReviewCode = :ReviewCode";
    ExecuteSQL($sqlDelete, array('ReviewCode' => $_POST["btnDeleteRow"]));
...
if(isset($_POST["btnUpdateFeedBack"])){
    ...
    $uploadFileTarget =  $GLOBALS["ROOT"]."/_content_images/".GetCurrentLang()."/review/";
...
<script>
    function _load_feedback_detail(reviewCode)
    {
        ...
        $("#panel-feedback-detail").load("../_master/_load_itemFeedback.php?ref="+reviewCode+"&cstar=<?php echo $_COG_REVIEW_STAR ?>",function(){
