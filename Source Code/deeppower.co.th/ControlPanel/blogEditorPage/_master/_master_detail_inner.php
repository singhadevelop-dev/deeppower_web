...
if(isset($_POST["btnSave"])){
    ...
    else
    {
        ...
        $sqlUpdate = "insert into portfolio (PortCode,PortName,PortDetail,PortHtml2,PortHtml3,Image,Image2,Image3,Video,FileDownload,FileDownloadName,Active,CreatedOn,CreatedBy,PortType,ShortDescription,PortDetail1,Year,ByName)
            VALUES(
                '$portCode',
                '$txtSubject',
                '$txtDetail',
        ...
        <div class="col-md-<?php echo $_COG_ALLOW_LEFT_MENU ? "10" : "12" ?>">
            <form method="post" enctype="multipart/form-data">
                ...
                <?php if($_COG_ALLOW_MASTER_AUTHOR){ ?>
                    <div class="row">
                        <div class="col-sm-10">
                            <label>หัวข้อรอง <?php echo $_COG_ITEM_NAME ?></label>
                            <input type="text" placeholder="หัวข้อรอง <?php echo $_COG_ITEM_NAME ?>" name="txtByName" id="txtByName" value="<?php echo $data["ByName"] ?>" class="form-control input-sm require" />
                        </div>
                    </div>
                <?php } ?>
