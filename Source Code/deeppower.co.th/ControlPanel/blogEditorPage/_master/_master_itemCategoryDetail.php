...
if(isset($_POST["btnSave"])){
    ...
    $uploadFileTarget = $GLOBALS["ROOT"]."/ControlPanel/assets/images/category/";
...
if(!empty($_GET["ref"]))
{
    $sql = "select * from product_category where CategoryCode = :cateCode";
    $data = SelectRow($sql, array('cateCode' => $_GET["ref"]));
}
?>
