...
if(isset($_POST["btnSortable"])){
    ...
    foreach ($sort as $value)
    {
        ...
        ExecuteSQL($sqlSortUpdate, array(
            'SEQ' => $value->seq,
...
if(isset($_POST["btnUpload"])){
    ...
    $imageName = pathinfo($fileUploaded["name"], PATHINFO_FILENAME);
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row" id="sortable">
                            <?php
                            $sql = "select * from gallery where RefCode = :refCode order by SEQ, ImageCode";
                            $datas = SelectRows($sql, array('refCode' => ($portCode.$_GET["no"])));
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <p>
                                                                ...
                                                                <input type="text"  class="form-control input-sm"  name="txtImageName3" value="<?php echo $data["ImageName3"] ?>" />
                                                            </p>
                                                            <?php } ?>
                        ...
                        <div class="panel-footer">
                            <b class="text-danger">
                                <small>*ขนาดภาพที่เหมาะสมที่สุดคือ <?php echo $_COG_ALLOW_GALLERY_SIZE ?> pixels</small>
                            </b>
                        </div>
                    </div>
                    <script>
