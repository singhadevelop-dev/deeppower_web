...
if($_COG_ALLOW_CATEGORY){
    array_push($_ALL_MENU,array("CATEGORY","itemCategory.php","หมวดหมู่".$_COG_ITEM_NAME));
}
if($_COG_ALLOW_CATEGORY_SUB){
    array_push($_ALL_MENU,array("CATEGORY2","itemSubCategory.php","หมวดหมู่".$_COG_ITEM_NAME. " ย่อย 2"));
}
if($_COG_ALLOW_CATEGORY_SUB3){
    array_push($_ALL_MENU,array("CATEGORY3","itemSubCategory3.php","หมวดหมู่".$_COG_ITEM_NAME. " ย่อย 3"));
}
if($_COG_ALLOW_LEFT_MENU_FEEDBACK){
    array_push($_ALL_MENU,array("FEEDBACK","itemFeedBack.php","รีวิว"));
}
...
if($_COG_ALLOW_PROPERTIES){
    array_push($_ALL_MENU,array("PROPERTIES","itemProperties.php","คุณสมบัติ".$_COG_ITEM_NAME));
}
