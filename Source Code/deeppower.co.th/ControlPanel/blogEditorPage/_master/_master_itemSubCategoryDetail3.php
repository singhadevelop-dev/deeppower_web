...
if(isset($_POST["btnSave"])){
    ...
    $uploadFileTarget = $GLOBALS["ROOT"]."/_content_images/".GetCurrentLang()."/product_subcategory3/";
    ...
    if(empty($_GET["ref"])){
        ...
        $sql = "update product_sub_category3 set
                ...
                where SubCategoryCode3 = :SubCategoryCode3
        ";
        $values = array(
             'SubCategoryName3' => $txtSubject
            ,'SubCategoryDetail' => $txtDetail
            ...
            ,'CategoryCode' => $ddlBrand
            ,'SubCategoryCode1' => $ddlSubCategory
            ,'SubCategoryCode3' => $_GET["ref"]
        );
    }
    ExecuteSQLTransaction($sql, $values, "itemSubCategory3.php");
}

if(!empty($_GET["ref"]))
{
    $sql = "select * from product_sub_category3 where SubCategoryCode3 = :SubCategoryCode3";
    $data = SelectRow($sql, array('SubCategoryCode3' => $_GET["ref"]));
}
?>
...
<div class="mat-box grey-bar">
    ...
    /
    <a href="itemSubCategory3.php" class="link-history-btn">รายการหมวดหมู่<?php echo $_COG_ITEM_NAME ?>ย่อย 3</a>
    /
    <span class="link-history-btn">จัดการหมวดหมู่<?php echo $_COG_ITEM_NAME ?>ย่อย 3</span>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-sm-6">
                                ...
                                <select name="ddlBrand" class="form-control input-sm require">
                                    <?php echo GetDropDownListOptionWithDefaultSelectedAndCondition("product_category","CategoryCode","CategoryName","กรุณาเลือก",$data["CategoryCode"], array('Active' => 1, 'CategoryGroup' => $_COG_ITEM_CODE)) ?>
                                </select>
                            </div> -->
                        </div>
                        <div class="row">
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <p>
                                <small class="text-danger">*ขนาดภาพที่เหมาะสมที่สุดคือ 500 x 614 pixels</small>
                            </p>

                            <img id="imge-preview" src="<?php echo empty($data["Image"]) ? "https://dummyimage.com/500x614" : $data["Image"] ?>" 
