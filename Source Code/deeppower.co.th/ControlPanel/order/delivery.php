...
if(isset($_POST["btnChangType"])){
    $sqlUpdate = "update website set DeliveryType = :DeliveryType ";
    ExecuteSQL($sqlUpdate, array('DeliveryType' => $_POST["rdo-deliverytype"]));
}

if(isset($_POST["btnDeleteRow"])){
    $sql = "DELETE FROM `delivery_type` WHERE `Code` = :Code";
    ExecuteSQL($sql, array('Code' => $_POST["btnDeleteRow"]));
}
