...
if(isset($_POST["btnSave"])){
    ...
    $uploadFileTarget =  $GLOBALS["ROOT"]."/_content_images/".GetCurrentLang()."/bank/";
    ...
    ExecuteSQLTransaction($sql, $values, "payment.php");
}

if(!empty($_GET["ref"]))
{
    $sql = "select * from bank where BankCode = :BankCode";
    $data = SelectRow($sql, array('BankCode' => $_GET["ref"]));
}
?>
