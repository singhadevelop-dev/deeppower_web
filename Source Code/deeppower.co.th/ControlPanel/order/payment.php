...
if(isset($_POST["btnDeleteRow"])){
    $sql = "delete from bank where BankCode = :BankCode";
    ExecuteSQL($sql, array('BankCode' => $_POST["btnDeleteRow"]));
}
       ...
       <div class="col-md-2">
        ...
        <div class="col-md-10">
            ...
            <div class="hide">
                ...
                $dataPayPal = SelectRow($sql, array());
                ?>
                ...
                <form method="post" class="panel panel-primary ">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" placeholder="Public key.." name="txtPayPalEmail"  class="form-control"  value="<?php echo $dataPayPal["AccountName"] ?>" />
                            </div>
                            <div class="col-md-12">
                                <label>Secret key</label>
                                <input type="text" placeholder="Secret key.." name="txtPayPalMerchant" class="form-control"  value="<?php echo $dataPayPal["Number"] ?>" />
                            </div>
                        </div>
                    ...
                    <div class="panel-footer">
                        ...
                        <a href="https://dashboard.omise.co/v2/" target="_blank" class="btn btn-info"><i class="fa fa-book"></i> Dashboard Omise</a>
                    </div>
                </form>
            </div>
