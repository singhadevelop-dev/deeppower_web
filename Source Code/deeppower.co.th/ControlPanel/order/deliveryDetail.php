...
if(isset($_POST["btnSave"])){
    ...
    ExecuteSQLTransaction($sql, $values,"delivery.php");
}

if(!empty($_GET["ref"]))
{
    $sql = "select * from delivery_type where Code = :Code";
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                   ...
                   <div class="col-sm-6">
                        <label>ราคาประเภทการจัดส่ง</label>
                 ...
                 <div class="row">
                    <div class="col-sm-6 display-type-RATE 
