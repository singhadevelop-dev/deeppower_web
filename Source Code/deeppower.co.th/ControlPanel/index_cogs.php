...
if(isset($_POST["btnSave"])){
    ...
    ,cogs_logo_width = :cogs_logo_width
    ,cogs_logo_height = :cogs_logo_height
    ,cogs_email_host = :cogs_email_host
    ,cogs_email_username = :cogs_email_username
    ,cogs_email_password = :cogs_email_password
    ,cogs_host_name = :cogs_host_name
    ,cogs_host_extension = :cogs_host_extension
    ,cogs_google_tag_manager = :cogs_google_tag_manager
    ,cogs_google_analytics = :cogs_google_analytics
    ,AppIDPaypal = :AppIDPaypal
    ";
...
if(isset($_POST["btnConvertPath"])){
    ...
    foreach ($path_datas as $path) {
        ...
        $valuesArr[] = array(
            ...
            'path_from' => $cogs_image_path_from,
            'path_to' => $cogs_image_path_to,
            'path_from_like' => "".$cogs_image_path_from."%",
            'path_to_like' => "".$cogs_image_path_to."%",
        );


        $_where_con = " and :column_name NOT LIKE :path_to_like ";
        if(empty($cogs_image_path_to)){
            $_where_con = " and :column_name LIKE :path_from_like ";
        }
        array_push($_arr_sql,"update :table_name set :column_name = Concat(:path_to,'',REPLACE(:column_name, :path_from, ''))
        WHERE 1=1
    ...
    ExecuteMultiSQL($_arr_sql, $valuesArr);
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="post">
                ...
                <br class="hide" />
                <span class="hide"><b>Paypal Application ID </b></span>
                <hr style="margin-top: 5px;" class="hide" />
                <div class="row hide">
                    <div class="col-sm-8">
                ...
                <br class="hide" />
                <span class="hide"><b>Google Key Config</b></span>
                <hr style="margin-top: 5px;" class="hide" />
                <div class="row hide">
                    <div class="col-sm-4">
