...
if(isset($_POST["btnPicked"])){
    ...
    ExecuteSQL($sqlUpdate, array('MemberCode' => $_POST["btnPicked"]));
}

if(isset($_POST["btnDeleteRow"])){
    $sql = "delete from member where MemberCode = :MemberCode";
    ExecuteSQL($sql, array('MemberCode' => $_POST["btnDeleteRow"]));
}
    ...
    <div class="row" style="margin-bottom: 0;">
        <div class="col-sm-9">
            <h3 style="margin: 0;">
                ...
                <span class="analysis-left-menu-desc">ขอรับใบเสนอราคา</span>
            </h3>
        </div>
...
<div class="mat-box grey-bar">
    ...
    <a href="register.php" class="link-history-btn">ขอรับใบเสนอราคา</a>
    /
    <span class="link-history-btn">ข้อมูลขอรับใบเสนอราคา</span>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p class="" title="Product Name">
                                                    ...
                                                    Product Name : <span class="text-primary"><?php echo $data["ProductName"] ?></span>
                                                </p>
                                                <p class="hide">
