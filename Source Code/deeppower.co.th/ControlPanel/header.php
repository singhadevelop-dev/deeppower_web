    ...
    <nav class="navbar navbar-default z-depth-1 navbar-fixed-top" style="margin-bottom: 10px;">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="display: inline-block; white-space: nowrap; margin-top: -13px; width: auto; margin-right: 10px;" href="<?php echo $GLOBALS["ROOT"] ?>/ControlPanel/">
                    <!-- <i class="fa fa-desktop pull-left" style="color: #F58512; margin-right: 15px; margin-top: 4px; font-size: 40px;"></i> -->
                    <img class="img-head-logo" style="margin-right: 10px; margin-top: 4px;height: 40px;float:left;object-fit: cover;" src="<?php echo $__IMG_LOGO ?>"/>
                    <span class="nav-desc">
                ...
                <ul class="nav navbar-nav navbar-right analysis-top-menu">
                    ...
                    <li title="รายการสั่งซื้อ" class="hide">
                        <a href="<?php echo $GLOBALS["ROOT"] ?>/ControlPanel/transaction/">
                            <?php
                             $sqlCountWaitingPO = "select count(CheckOutCode) as num_rows from checkout where StatusCode = 'WAITING' or StatusCode = 'PAID'";
                             $numCountWaitingPO = intval(SelectRow($sqlCountWaitingPO, array())["num_rows"]);
                            ?>
                    ...
                    <li title="ผู้ติดต่อเข้ามายังเว็บไซต์" class="">
                        <a href="<?php echo $GLOBALS["ROOT"] ?>/ControlPanel/contact/contact.php">
                            ...
                            $numCountNotPick = intval(SelectRow($sqlCountNotPick, array())["num_rows"]);
                            ?>
                    ...
                    <li title="ขอรับใบเสนอราคา" class="hide">
                        <a href="<?php echo $GLOBALS["ROOT"] ?>/ControlPanel/register/register.php">
                            ...
                            ?>
                            <i class="fa fa-file fa-2x nav-icon" style="font-size: 24px;"><b class="badge <?php //echo $numCountNotPick == 0 ? "hide" : "" 
                                                                                                            ?>"><?php //echo $numCountNotPick; 
                                                                                                                                                                ?></b></i>
                        </a>
                    </li>
                    ...
                    <!-- <li title="จองแพ็คเกจทัวร์" class="hide">
                        <a href="<?php echo $GLOBALS["ROOT"] ?>/ControlPanel/register/subscribe.php">
                            ...
                            ?>
                            <i class="fa fa-list fa-2x nav-icon" style="font-size: 24px;"><b class="badge <?php //echo $numCountNotPick == 0 ? "hide" : "" 
                                                                                                            ?>"><?php //echo $numCountNotPick; 
                                                                                                                                                                ?></b></i>
                        </a>
                    </li> -->
