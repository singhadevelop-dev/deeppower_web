...
if(isset($_POST["btnSave"])){
    ...
    $uploadFileTarget = $GLOBALS["ROOT"]."/_content_images/".GetCurrentLang()."/product_subcategory/";
    ...
    if(empty($_GET["ref"])){
        ...
        $values = array(
            ...
            'CategoryCode' => $ddlBrand,
            'SubCategoryCode' => $_GET["ref"],
        );
    }
    
    ExecuteSQLTransaction($sql, $values, "productSubCategory.php");
}

if(!empty($_GET["ref"]))
{
    $sql = "select * from product_sub_category where SubCategoryCode = :SubCategoryCode";
    $data = SelectRow($sql, array('SubCategoryCode' => $_GET["ref"]));
}
?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 hide">
                        <div>
                            ...
                            <p>
                                <small class="text-danger">*ขนาดภาพที่เหมาะสมที่สุดคือ 600 x 450 pixels</small>
                            </p>

                            <img id="imge-preview" src="<?php echo empty($data["Image"]) ? "https://dummyimage.com/600x450,eee" : $data["Image"] ?>" 
