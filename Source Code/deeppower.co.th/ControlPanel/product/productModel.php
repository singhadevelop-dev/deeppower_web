...
if(isset($_POST["btnDeleteRow"])){
    $sql = "delete from product_model where ModelCode = :ModelCode";
    ExecuteSQL($sql, array('ModelCode' => $_POST["btnDeleteRow"]));
    
    $sql = "update product set ModelCode = '',ModelCode = '' where ModelCode = :ModelCode";
    ExecuteSQL($sql, array('ModelCode' => $_POST["btnDeleteRow"]));
}
