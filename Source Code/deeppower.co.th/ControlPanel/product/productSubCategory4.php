...
if(isset($_POST["btnDeleteRow"])){
    $sql = "delete from product_sub_category4 where SubCategoryCode4 = :SubCategoryCode4";
    ExecuteSQL($sql, array('SubCategoryCode4' => $_POST["btnDeleteRow"]));
    
    $sql = "update product set SubCategoryCode4 = '' where SubCategoryCode4 = :SubCategoryCode4";
    ExecuteSQL($sql, array('SubCategoryCode4' => $_POST["btnDeleteRow"]));
