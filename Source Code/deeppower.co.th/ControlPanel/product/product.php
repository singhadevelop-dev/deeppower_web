...
if (isset($_POST["btnDeleteRow"])) {
    ...
    ExecuteSQL($sql, array('ProductCode' => $_POST["btnDeleteRow"]));
    $sql = "delete from gallery where RefCode = :RefCode";
    ExecuteSQL($sql, array('RefCode' => $_POST["btnDeleteRow"]));
    $sql = "delete from product_properties_mapping where ProductCode = :ProductCode";
    ExecuteSQL($sql, array('ProductCode' => $_POST["btnDeleteRow"]));
}
                ...
                <table style="width: 100%;"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>ชื่อสินค้า</th>
                            <th>หมวดหมู่</th>
                            <th class="t-w50 text-center">สินค้าขายดี</th>
                        ...
                        ?>
                            <tr data-key="<?php echo $data["ProductCode"] ?>" data-seq="<?php echo $inx++ ?>">
                                ...
                                <td class="text-center">
                                    <i class="it-swi new fa <?php echo $data["Hot"] == 1 ? "active" : "" ?>" onclick="xNew(this)"></i>
                                </td>
                                <td class="text-center">
