...
if(isset($_POST["btnSubmit"])){
    ...
    for ($i = 1; $i < countval($txtPackageName); $i++)
    {
...
if(!empty($prdCode)){
    ...
    $data = SelectRow($prdQuery, array('ProductCode' => $prdCode));
}
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        $sqlPack = "select * from product_package where ProductCode = :ProductCode";
                        $dataPack = SelectRows($sqlPack, array('ProductCode' => $prdCode));
