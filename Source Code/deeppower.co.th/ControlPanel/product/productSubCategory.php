...
if(isset($_POST["btnDeleteRow"])){
    $sql = "delete from product_sub_category where SubCategoryCode = :SubCategoryCode";
    ExecuteSQL($sql, array('SubCategoryCode' => $_POST["btnDeleteRow"]));
    
    $sql = "update product set SubCategoryCode = '' where SubCategoryCode = :SubCategoryCode;
    update product_sub_category3 set SubCategoryCode = '' where SubCategoryCode = :SubCategoryCode;
    update product_sub_category4 set SubCategoryCode = '' where SubCategoryCode = :SubCategoryCode
    ";
    ExecuteMultiSQL($sql, array('SubCategoryCode' => $_POST["btnDeleteRow"]));
}
