...
if(isset($_POST["btnDeleteRow"])){
    $sql = "update product_properties set Active=0 where PropCode = :PropCode";
    ExecuteSQL($sql, array('PropCode' => $_POST["btnDeleteRow"]));
}
?>
        ...
        <div class="col-md-10">
            ...
            <table 
                ...
                <tbody>
                    ...
                    $sql = "select * from product_properties where Active=1 and PropGroup=:PropGroup order by SEQ";
                    $datas = SelectRows($sql, array('PropGroup' => $_COG_ITEM_CODE));
