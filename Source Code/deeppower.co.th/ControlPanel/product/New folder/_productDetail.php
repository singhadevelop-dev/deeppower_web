...
if (isset($_POST["btnSubmit"])) {
    ...
    $txtDiscount = doubleval(str_replace(",", "", $_POST["txtDiscount"]));
    ...
    //FILE 4
    $fileDownloadUpload4 = $_FILES["txtFileUpload4"];
    if (!empty($fileDownloadUpload4["name"])) {
        $fileDownloadUploadPath4 = $fileDownloadTarget . UploadFile($_FILES["txtFileUpload4"], $fileDownloadTarget);
        $fileDownloadName4 = $fileDownloadUpload4["name"];
    } else {
        $fileDownloadUploadPath4 = $_POST["hddBackUpFileDownload4"];
        $fileDownloadName4 = $_POST["hddBackUpFileDownloadName4"];
    }
    //FILE 5
    $fileDownloadUpload5 = $_FILES["txtFileUpload5"];
    if (!empty($fileDownloadUpload5["name"])) {
        $fileDownloadUploadPath5 = $fileDownloadTarget . UploadFile($_FILES["txtFileUpload5"], $fileDownloadTarget);
        $fileDownloadName5 = $fileDownloadUpload5["name"];
    } else {
        $fileDownloadUploadPath5 = $_POST["hddBackUpFileDownload5"];
        $fileDownloadName5 = $_POST["hddBackUpFileDownloadName5"];
    }
    ...
    if (!empty($prdCode)) {
        $sqlUpdate = "update product set 
                    ...
                    ,FileDownload4 = '$fileDownloadUploadPath4'
                    ,FileDownload5 = '$fileDownloadUploadPath5'
                    ,FileDownloadName = '$fileDownloadName'
                    ,FileDownloadName2 = '$fileDownloadName2'
                    ,FileDownloadName3 = '$fileDownloadName3'
                    ,FileDownloadName4 = '$fileDownloadName4'
                    ,FileDownloadName5 = '$fileDownloadName5'
                    ,Active = '$chkActive'
                    ,UpdatedOn = NOW()
                    ...
                    ,ShopeeLink='$txtShopeeLink'
                    ,LazadaLink='$txtLazadaLink'
        ...
        $sqlInsert = "insert into product (ProductCode,ProductName,ShortDescription,ShortDescription2,ProductDetail,ProductDetail2,ProductDetail3,ProductDetail4,ProductDetail5,ProductDetail6,Image,Image2,Image3,Image4,Video,Video2
                        ,FileDownload,FileDownload2,FileDownload3,FileDownload4,FileDownload5,FileDownloadName,FileDownloadName2,FileDownloadName3,FileDownloadName4,FileDownloadName5,Active,CreatedOn,CreatedBy
                        ...
                        ,TaxInfo,Vendor,Collection,Barcode,ColorCode,ColorCode2,ShopeeLink,LazadaLink,Transmission,Branch,Title,Description,KeyWord,Mileage,Year,Discount)
                    VALUES(
                        '$prdCode',
                        '$txtSubject',
                        '$txtShortDescription',
                        ...
                        '$fileDownloadUploadPath4',
                        '$fileDownloadUploadPath5',
                        '$fileDownloadName',
                        '$fileDownloadName2',
                        '$fileDownloadName3',
                        '$fileDownloadName4',
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 hide">
                                ...
                                <input type="text" placeholder="ทะเบียนรถ..." name="txtCustomer" id="txtCustomer" value="<?php echo $data["Customer"] ?>" class="form-control input-sm require" />
                            </div>
                        </div>
                        ...
                        <div class="alert alert-success hide">
                            <div class="row">
                                ...
                                <div class="col-sm-6 hide">
                                    <label>สาขา</label>
                                    <input type="text" placeholder="สาขา..." name="txtBranch" id="txtBranch" value="<?php echo $data["Branch"] ?>" class="form-control input-sm require" />
                                </div>
                                <div class="col-sm-4 hide">
                                    <label>ระบบเกียร์</label>
                                    <input type="text" placeholder="ระบบเกียร์..." name="txtTransmission" id="txtTransmission" value="<?php echo $data["Transmission"] ?>" class="form-control input-sm require" />
                                </div>
                                <div class="col-sm-4 hide">
                                    <label>เลขไมล์</label>
                                    <input type="text" placeholder="เลขไมล์..." name="txtMileage" id="txtMileage" value="<?php echo $data["Mileage"] ?>" class="form-control input-sm require" />
                                </div>
                                <div class="col-sm-4 hide">
                                    <label>ปีรถ</label>
                                    <input type="text" placeholder="ปีรถ..." name="txtYear" id="txtYear" value="<?php echo $data["Year"] ?>" class="form-control input-sm require" />
                                </div>
                                <div class="col-sm-6 hide">
                            ...
                            <div class="alert alert-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 hide">
                                        ...
                                        <!-- <span class="text-muted">(บาท)</span> -->
                                        <input type="text" step="1" placeholder="ราคาเดิม..." name="txtDiscount" id="txtDiscount" value="<?php echo number_format($data["Discount"], 2) ?>" class="form-control input-sm require text-right" onkeypress="IsKeyNumber(event);" onchange="IsFormatNumber(this);" />
                                    </div>
                                    <div class="col-sm-6 hide">
                                        <label>ราคารวมภาษี</label>
                                        <span class="text-muted">(บาท)</span>
                                        <input type="text" step="1" placeholder="ราคารวมภาษี..." name="txtBasePrice" id="txtBasePrice" value="<?php echo number_format($data["BasePrice"], 2) ?>" class="form-control input-sm require text-right" onkeypress="IsKeyNumber(event);" onchange="IsFormatNumber(this);" />
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row hide">
                                    <div class="col-sm-12 ">
                                        ...
                                        <input type="text" placeholder="Shopee..." name="txtShopeeLink" id="txtShopeeLink" value="<?php echo $data["ShopeeLink"] ?>" class="form-control input-sm" />
                                    </div>
                                    <div class="col-sm-12 ">
                                        <label>Lazada URL</label>
                                        <input type="text" placeholder="Lazada..." name="txtLazadaLink" id="txtLazadaLink" value="<?php echo $data["LazadaLink"] ?>" class="form-control input-sm" />
                                    </div>
                                </div>
                            </div>
                            <?php if (false) { ?>
                        ...
                        <div class="alert alert-warning hide">
                            ...
                            <div class="row ">
                                <!-- <div class="col-sm-6">
                                    ...
                                    <input type="text" placeholder="ชื่อลูกค้า..." name="txtCustomer" id="txtCustomer" value="<?php //echo $data["Customer"] 
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-striped" style="background: #fff">
                                            ...
                                            <tbody>
                                                <?php
                                                $sqlPropUnique = "select * from product_properties_mapping where ProductCode='" . $data["ProductCode"] . "' order by PropCode asc ";
                        ...
                        <div class="product-tag-container">
                            ...
                            <div class="row">
                                <?php
                                $sqlTags = "select * from tag where Active = 1 and TagType = 'PROMO' order by TagName";
                                $dataTags = SelectRowsArray($sqlTags);
                                foreach ($dataTags  as $tag) {
                                ?>
                                    <div class="col-sm-6" onclick="$(this).find('input').click();">
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <div class="hide">
                                ...
                                <hr style="margin-top: 5px; margin-bottom: 5px;" />
                                <p>
                                    <small class="text-danger">*ขนาดภาพที่เหมาะสมที่สุดคือ 561 x 561 pixels</small>
                                </p>
                                <div id="imge-preview" class="image-box hand" onclick="$(this).next().click();" style="margin:0 auto; width: 100%; height: 230px;margin-bottom:15px; background-image: url(<?php echo $data["Image"] ?>), url('https://ipsumimage.appspot.com/800x800,eee')">
                                </div>
                            ...
                            <!-- image 2 -->
                            <div class="hide">
                                <span><b>รายละเอียดโปรโมชั่น</b></span>
                                <hr style="margin-top: 5px; margin-bottom: 5px;" />
                                <!-- <p>
                                    <small class="text-danger">*ขนาดภาพที่เหมาะสมที่สุดคือ 730 x 540 pixels</small>
                                </p> -->
                                <div id="imge-preview-2" class="image-box hand" onclick="$(this).next().click();" style="margin:0 auto; width: 100%; height: 230px;margin-bottom:15px; background-image: url(<?php echo $data["Image2"] ?>), url('https://ipsumimage.appspot.com/730x540,eee')">
                                </div>
                            ...
                            <div class="hide">
                                ...
                                <div id="imge-preview3" class="image-box hand" onclick="$(this).next().click();" style="margin:0 auto; width: 100%; height: 230px;margin-bottom:15px; background-image: url(<?php echo $data["Image3"] ?>), url('https://ipsumimage.appspot.com/800x800,eee')">
                                </div>
                            ...
                            <div class="product-material-container">
                                ...
                                <div class="row">
                                    ...
                                    $sqlTags = "select * from tag where TagType = 'TYPE' and Active = 1 order by TagName";
                            ...
                            <div class="product-recommend-container">
                                ...
                                <script>
                                    ...
                                    <?php if (!empty($_GET["ref"]) && $data["Recommend"] == 0) { ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="slide-banner h-auto">
                                            <span><b> อัพโหลดไฟล์</b></span>
                                            <hr style="margin-top: 5px; margin-bottom: 5px;" />

                                            <input type="file" name="txtFileUpload" value="" accept="*" onchange="validateUploadFileUpload(this);$(this).closest('.slide-banner').find('.remover').removeClass('hide');" />
                            ...
                            <div class="product-file-container">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="slide-banner h-auto">
                                            <span><b> อัพโหลดไฟล์ 2</b></span>
                                            <hr style="margin-top: 5px; margin-bottom: 5px;" />

                                            <input type="file" name="txtFileUpload2" value="" accept="*" onchange="validateUploadFileUpload(this);$(this).closest('.slide-banner').find('.remover').removeClass('hide')" />
                            ...
                            <div class="product-file-container">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="slide-banner h-auto">
                                            <span><b>อัพโหลดไฟล์ 3</b></span>
                                            <hr style="margin-top: 5px; margin-bottom: 5px;" />

                                            <input type="file" name="txtFileUpload3" value="" accept="*" onchange="validateUploadFileUpload(this);" />
                            ...
                            <div class="product-file-container">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="slide-banner h-auto">
                                            <span><b>อัพโหลดไฟล์ 4</b></span>
                                            <hr style="margin-top: 5px; margin-bottom: 5px;" />

                                            <input type="file" name="txtFileUpload4" value="" accept="*" onchange="validateUploadFileUpload(this);" />

                                            <?php if (!empty($data["FileDownload4"])) { ?>
                                                <div class="file-display" style="margin-top:5px;">
                                                    <b class="text-success">เคยอัพโหลดไฟล์แล้ว
                                                        <a target="_blank" href="<?php echo $data["FileDownload4"]; ?>">
                                                            <i class="fa fa-download"></i>
                                                            ดาวน์โหลด</a>
                                                    </b>
                                                </div>
                                            <?php } ?>
                                            <input type="hidden" name="hddBackUpFileDownload4" value="<?php echo $data["FileDownload4"] ?>" />
                                            <input type="hidden" name="hddBackUpFileDownloadName4" value="<?php echo $data["FileDownloadName4"] ?>" />
                                            <i class="fa fa-trash remover <?php echo empty($data["FileDownload4"]) ? "hide" : "" ?>" onclick="deletefile(this);"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="product-file-container">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="slide-banner h-auto">
                                            <span><b>อัพโหลดไฟล์ 5</b></span>
                                            <hr style="margin-top: 5px; margin-bottom: 5px;" />

                                            <input type="file" name="txtFileUpload5" value="" accept="*" onchange="validateUploadFileUpload(this);" />

                                            <?php if (!empty($data["FileDownload5"])) { ?>
                                                <div class="file-display" style="margin-top:5px;">
                                                    <b class="text-success">เคยอัพโหลดไฟล์แล้ว
                                                        <a target="_blank" href="<?php echo $data["FileDownload5"]; ?>">
                                                            <i class="fa fa-download"></i>
                                                            ดาวน์โหลด</a>
                                                    </b>
                                                </div>
                                            <?php } ?>
                                            <input type="hidden" name="hddBackUpFileDownload5" value="<?php echo $data["FileDownload5"] ?>" />
                                            <input type="hidden" name="hddBackUpFileDownloadName5" value="<?php echo $data["FileDownloadName5"] ?>" />
                                            <i class="fa fa-trash remover <?php echo empty($data["FileDownload5"]) ? "hide" : "" ?>" onclick="deletefile(this);"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <script>
                                function validateUploadFileUpload(obj) {
                                    ...
                                    if (file.size > maxSize) {
                                        $(obj).val("");
                                        swal("Invalid file size", "Maximum image size is 150 MB.", "error");
                                    }
                                }
                            </script>
                ...
                <div>
                    ...
                    <button type="submit" id="mainsavebtn" name="btnSubmit" class="btn btn-success" onclick="return validateSave(this);">
                        <i class="fa fa-save"></i>
                        บันทึก
                    </button>
                    <?php
                    $refcodearr = [];
                    $prodrefcode = (SelectRowsArray("SELECT ProductRefCode FROM product"));
                    foreach ($prodrefcode as $ref) {
                        array_push($refcodearr, $ref["ProductRefCode"]);
                    }
                    $refcodejson = json_encode($refcodearr);
                    ?>
                    <script>
                        let refcode = document.getElementById("txtRefCode");
                        let originref = '<?php echo $data["ProductRefCode"]; ?>';
                        let oldrefarr = <?php echo $refcodejson; ?>;
                        let mainsavebtn = document.getElementById("mainsavebtn");
                        refcode.onchange = function() {
                            let found = (oldrefarr.indexOf(refcode.value) > -1);
                            if (found == true && refcode.value != originref) {
                                refcode.style.cssText = "border: 1px solid red;background-color: #ff3344;color: white;";
                                mainsavebtn.setAttribute("disabled", "");
                                AlertError("Duplicate Product Number");
                            } else {
                                refcode.style.cssText = "";
                                mainsavebtn.removeAttribute("disabled");
                            }
                        }
                    </script>
                    ...
                    <script>
                        function validateSave(sender) {
                            ...
                            if ($(".product-tag-container").is(":visible") && $(".chk-tag-keyword:checked").length > 2) {
                                msg.push("เลือกโปรโมชั่น สูงสุดเพียง 2 รายการเท่านั้น");
                            }
                            if (msg.length > 0) {
