...
if(isset($_POST["btnDeleteRow"])){
    ...
    $sql = "update product set SubCategoryCode3 = '' where SubCategoryCode3 = :SubCategoryCode3";
    ExecuteSQL($sql, array('SubCategoryCode3' => $_POST["btnDeleteRow"]));

    $sql = "update product_sub_category4 set SubCategoryCode3 = '' where SubCategoryCode3 = :SubCategoryCode3";
    ExecuteSQL($sql, array('SubCategoryCode3' => $_POST["btnDeleteRow"]));
}
