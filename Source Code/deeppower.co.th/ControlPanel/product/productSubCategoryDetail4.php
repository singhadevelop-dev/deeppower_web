...
if(isset($_POST["btnSave"])){
    ...
    $uploadFileTarget = $GLOBALS["ROOT"]."/_content_images/".GetCurrentLang()."/product_subcategory4/";
    ...
    if(empty($_GET["ref"])){
        ...
        $sql = "update product_sub_category4 set
                SubCategoryName4 = :SubCategoryName4
                ...
                where SubCategoryCode4 = :SubCategoryCode4
        ";
        $values = array(
            'SubCategoryName4' => $txtSubject,
            'SubCategoryDetail' => $txtDetail,
            ...
            'SubCategoryCode2' => $ddlSubCategory,
            'SubCategoryCode3' => $ddlSubCategory3,
            'SubCategoryCode4' => $_GET["ref"],
        );
    }
    
    ExecuteSQLTransaction($sql, $values, "productSubCategory4.php");
}

if(!empty($_GET["ref"]))
{
    $sql = "select * from product_sub_category4 where SubCategoryCode4 = :SubCategoryCode4";
    $data = SelectRow($sql, array('SubCategoryCode4' => $_GET["ref"]));
}
?>
