...
if(isset($_POST["btnDeleteRow"])){
    $sql = "delete from product_sub_detail WHERE ProductCode=:ProductCode and SubDetailCode= :SubDetailCode";
    ExecuteSQL($sql,array('ProductCode' => $get_ref,'SubDetailCode' => $_POST["btnDeleteRow"]));
}
?>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <table 
                ...
                <tbody>
                    <?php
                    $sql = "select * from product_sub_detail WHERE ProductCode=:ProductCode order by SEQ";
                    $datas = SelectRows($sql,array('ProductCode' => $get_ref));
