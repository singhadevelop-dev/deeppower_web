...
if(isset($_POST["btnDeleteRow"])){
    $sql = "update tag set Active=0 where TagType='SIZE' and TagCode = :TagCode";
    ExecuteSQL($sql, array('TagCode' => $_POST["btnDeleteRow"]));
}
?>
        ...
        <div class="col-md-9">
            ...
            <table class="jquery-datatable display" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    $sql = "select * from tag where TagType = 'SIZE' and Active=1 order by TagCode";
