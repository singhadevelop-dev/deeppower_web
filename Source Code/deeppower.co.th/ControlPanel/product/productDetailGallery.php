...
if(isset($_POST["btnUpdateImage"])){
    ...
    $uploadFileTarget =  $GLOBALS["ROOT"]."/_content_files/".GetCurrentLang()."/product_gallery/";
...
if(isset($_POST["btnUpload"])){
    ...
    if(isset($_FILES["fileUpload"]))
    {
        foreach($_FILES['fileUpload']['tmp_name'] as $key => $val)
        {
            ...
            $uploadFileTarget =  $GLOBALS["ROOT"]."/_content_files/".GetCurrentLang()."/product_gallery/";
            $fileUploadedPath = $uploadFileTarget.UploadFileMultiFile($file_name,$uploadFileTarget,$file_tmp);
...
if(!empty($refCode)){
    ...
    $data = SelectRow($sqlPrd, array('ProductCode' => $refCode));
}
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                         ...
                         <div class="row" id="sortable">
                            ...
                            $datas = SelectRows($sql, array('RefCode' => $refCode));
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-lg-12">
                                                            ...
                                                            style="width: 100%; height: 320px;margin-bottom:5px; background-image: url(<?php echo $data["ImagePath"] ?>), url('https://ipsumimage.appspot.com/800x800,eee')">
                                                                </div>
                                                        ...
                                                        <div class="col-sm-8 col-lg-8 hide">
                                                            <p>
                            ...
                            <div class="col-sm-4 col-lg-4">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <input class="hide" type="file" onchange="uploadBanner(this);"
                                        name="fileUpload[]" id="fileUpload" multiple="multiple" accept="image/*" />
