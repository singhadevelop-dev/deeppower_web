...
if(isset($_POST["btnSave"])){
    ...
    ExecuteSQLTransaction($sql, $values, "productModel.php");
}

if(!empty($_GET["ref"]))
{
    $sql = "select * from product_model where ModelCode = :ModelCode";
    $data = SelectRow($sql, array('ModelCode' => $_GET["ref"]));
}
?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="ddlBrand" class="form-control input-sm require">
                                    <?php echo GetDropDownListOptionWithDefaultSelectedAndCondition("product_brand","BrandCode","BrandName","กรุณาเลือก",$data["BrandCode"], array('Active' => 1)) ?>
                                </select>
                            </div>
                        </div>
