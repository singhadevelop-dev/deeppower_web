...
<?php
$clientCode = $_GET["ref"];
$data = SelectRow("select * from client where ClientCode=:ClientCode ",array('ClientCode' => $clientCode));
?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" name="FirstName" placeholder="First Name..." value="<?php echo $data["Name"]." ".$data["Name2"]; ?>" readonly>
                                                        </div>
                                                        <div class="col-md-3 hide">
