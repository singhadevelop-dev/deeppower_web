...
$uploadFileTarget =  $GLOBALS["ROOT"]."/_content_images/".GetCurrentLang()."/".strtolower($_CUSTOM_CONTENT)."/";
...
if (isset($_POST["btnUpload"])) {
    ...
    $dataMax = SelectRow($sqlMax, array('RefCode' => $_CUSTOM_CONTENT));
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" id="sortable">
                            ...
                            $datas = SelectRows($sql, array('RefCode' => $_CUSTOM_CONTENT));
                            $xCountItem = 0;
