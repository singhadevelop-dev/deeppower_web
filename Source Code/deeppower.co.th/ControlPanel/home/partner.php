...
if(isset($_POST["btnUpdateImage"])){
    $uploadFileTarget = $GLOBALS["ROOT"]."/_content_images/".GetCurrentLang()."/client/";
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            $sql = "select * from gallery where RefCode = :RefCode order by ImageCode";
                            $datas = SelectRows($sql, array('RefCode' => 'CLIENT'));
                            ...
                            <div class="col-sm-4 col-lg-3">
                                <form method="post" enctype="multipart/form-data">
                                    <div class="slide-banner image-box slide-adder hand" onclick="$(this).next().click();" style="position: relative; background-image: url('https://ipsumimage.appspot.com/520x480,eee');">
