...
function GetGalleryData($_REF_CODE)
{
    ...
    $data = SelectRow($sql, array('RefCode' => $_REF_CODE));
    return $data;
}

if(isset($_POST["btnDelete"])){
    $sqlDelete = "update gallery set ImagePath='' where ImageCode = :ImageCode";
...
if(isset($_POST["btnUpload"])){
    ...
    if($data !== false)
    {
        ...
        ExecuteSQL($sqlDelete, array('ImagePath' => $fileUploadedPath, 'ImageCode' => $data["ImageCode"]));
    }
    else
    {
        $fileUploaded = $_FILES["fileUpload"];
...
if(isset($_POST["btnDelete3"])){
    $sqlDelete = "update gallery set ImagePath3='' where ImageCode = :ImageCode";
    ExecuteSQL($sqlDelete, array('ImageCode' => $_POST["btnDelete3"]));
    $filePath = $_POST["hddFilePath3"];
    unlink($_SERVER['DOCUMENT_ROOT'].$filePath);
}
if(isset($_POST["btnUpload3"])){
    $uploadFileTarget =  $GLOBALS["ROOT"]."/_content_images/".GetCurrentLang()."/home_banner_featured/image3/";
    $data = GetGalleryData($_COG_REF_CODE);
    if($data !== false)
    {
        ...
        $sqlDelete = "update gallery set
            ...
            where ImageCode = :ImageCode";
        ExecuteSQL($sqlDelete, array('ImagePath3' => $fileUploadedPath, 'ImageCode' => $data["ImageCode"]));
    }
    else
    {
        $fileUploaded = $_FILES["fileUpload3"];
...
if(isset($_POST["btnDelete4"])){
    $sqlDelete = "update gallery set ImagePath4='' where ImageCode = :ImageCode";
    ExecuteSQL($sqlDelete, array('ImageCode' => $_POST["btnDelete4"]));
    $filePath = $_POST["hddFilePath4"];
    unlink($_SERVER['DOCUMENT_ROOT'].$filePath);
}
if(isset($_POST["btnUpload4"])){
    $uploadFileTarget =  $GLOBALS["ROOT"]."/_content_images/".GetCurrentLang()."/home_banner_featured/image4/";
    $data = GetGalleryData($_COG_REF_CODE);
    if($data !== false)
    {
        ...
        $sqlDelete = "update gallery set
            ...
            where ImageCode = :ImageCode";
        ExecuteSQL($sqlDelete, array('ImagePath4' => $fileUploadedPath, 'ImageCode' => $data["ImageCode"]));
    }
    else
    {
        $fileUploaded = $_FILES["fileUpload4"];
...
if(isset($_POST["btnDeleteVideo"])){
    $sqlDelete = "update gallery set ImagePath2='' where ImageCode = :ImageCode";
    ExecuteSQL($sqlDelete, array('ImageCode' => $_POST["btnDeleteVideo"]));
...
if(isset($_POST["btnUploadVideo"])){
    ...
    if($data !== false)
    {
        ...
        $sqlDelete = "update gallery set
            ...
            where ImageCode = :ImageCode";
        ExecuteSQL($sqlDelete, array('ImagePath2' => $fileUploadedPath, 'ImageCode' => $data["ImageCode"]));
    }
    else
    {
        $fileUploaded = $_FILES["fileUploadVideo"];
...
$sql = "select * from gallery where RefCode = :RefCode order by SEQ";
$data = SelectRow($sql, array('RefCode' => $_COG_REF_CODE));
