<div>
    ...
    <a class="left-group hide" data-det-group="SLIDE" href="<?php echo $GLOBALS["ROOT"] ?>/ControlPanel/home/slide.php">รูปภาพสไลด์ (แบนเนอร์)<i class="fa fa-caret-right pull-right"></i></a>
    ...
    <a class="left-group hide" data-det-group="SLIDEVIDEO" href="<?php echo $GLOBALS["ROOT"] ?>/ControlPanel/home/slideVideo.php">วีดีโอ (แบนเนอร์หน้าอื่นๆ)<i class="fa fa-caret-right pull-right"></i></a>
    ...
    <?php 
        // $sqlPageConfigs = "select * from page_config where Active=1 and PageCode <> 'HOME'  order by SEQ";
