                                    ...
                                    <div class="modal-dialog text-left">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <hr />
                                                <p class="" title="หัวข้อที่ติดต่อ">
                                                    <i class="fa fa-tasks fa-fw"></i>
                                                    หัวข้อที่ติดต่อ: <b class="text-primary"><?php echo !empty($data["Subject"]) ? $data["Subject"] : "-" ?></b>
                                                </p>
                                                <p class="hide" title="ชื่อบริษัท">
                                                    <i class="fa fa-building fa-fw"></i>
                                                    ชื่อบริษัท: <b class="text-primary"><?php echo !empty($data["Company"]) ? $data["Company"] : "-" ?></b>
                                                </p>
                                                ...
                                                <p class="hide" title="line id">
                                                    ...
                                                    LineID: <b class="text-primary"><?php echo $data["LineID"] ?></b>
                                                </p>
