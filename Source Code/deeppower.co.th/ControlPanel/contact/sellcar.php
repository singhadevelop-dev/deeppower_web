                            ...
                            <tr class="<?php echo $data["Picked"] == 1 ? "picked" : "no-picked" ?>">
                                ...
                                <td class="text-center">
                                    ...
                                    <form method="post" style="display:inline">
                                        <button type="submit" class="btn-link" onclick="return Confirm(this,'ต้องการลบรายการนี้หรือไม่ ?');" value="<?php echo $data["MemberCode"] ?>" name="btnDeleteRow">
                                        ...
                                        <div class="modal-dialog text-left">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p class="" title="ยี่ห้อรถ">
                                                        <i class="fa fa-car"></i>
                                                        ยี่ห้อรถ: <b class="text-primary"><?php echo !empty($data["Brand"]) ? $data["Brand"] : "-"  ?></b>
                                                    </p>
                                                    <p class="" title="รุ่นรถยนต์">
                                                        <i class="fa fa-car fa-fw"></i>
                                                        รุ่นรถยนต์: <b class="text-primary"><?php echo !empty($data["Model"]) ? $data["Model"] : "-"  ?></b>
                                                    </p>
                                                    <p class="" title="ปีรถ">
                                                        <i class="fa fa-calendar fa-fw"></i>
                                                        ปีรถ: <b class="text-primary"><?php echo !empty($data["Year"]) ? $data["Year"] : "-"  ?></b>
                                                    </p>
                                                    <p class="" title="ประเภทรถ">
                                                        <i class="fa fa-star fa-fw"></i>
                                                        ประเภทรถ: <b class="text-primary"><?php echo !empty($data["Type"]) ? $data["Type"] : "-"  ?></b>
                                                    </p>
                                                    <p class="" title="เครื่องยนต์">
                                                        <i class="fa fa-cogs fa-fw"></i>
                                                        เครื่องยนต์: <b class="text-primary"><?php echo !empty($data["Engine"]) ? $data["Engine"] : "-"  ?></b>
                                                    </p>
                                                    <p class="" title="ระบบเกียร์">
                                                        <i class="fa fa-cog fa-fw"></i>
                                                        ระบบเกียร์: <b class="text-primary"><?php echo !empty($data["Transmission"]) ? $data["Transmission"] : "-"  ?></b>
                                                    </p>
                                                    ...
                                                    <?php
                                                    $gallery = SelectRowsArray("SELECT * FROM gallery WHERE RefCode='" . $data["MemberCode"] . "'");
                                                    ?>
                                                    <div class="owl-carousel">
                                                        <?php foreach ($gallery as $item) { ?>
                                                            <div><a class="image-link" href="<?php echo $item["ImagePath"]; ?>" target="_blank"><img src="<?php echo $item["ImagePath"]; ?>" /></a></div>
                                                        <?php } ?>
                                                    </div>
                                                    <script>
...
<script src="../assets/b4w-library/owlcarousel/jquery.min.js"></script>
<script src="../assets/b4w-library/owlcarousel/owl.carousel.min.js"></script>
<script src="../assets/b4w-library/magnificpopup/jquery.magnific-popup.js"></script>
