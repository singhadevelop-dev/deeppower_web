                ...
                <table class="jquery-datatable display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo $data["Picked"] == 1 ? "picked" : "no-picked" ?>">
                            ...
                            <td class=""><?php echo !empty($data["Email"]) ? $data["Email"] : "-" ?></td>
                                    ...
                                    <div class="modal-dialog text-left">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p class="" title="Line ID">
                                                    <i class="fa fa-tasks fa-fw"></i>
                                                    Line ID: <b class="text-primary"><?php echo !empty($data["LineID"]) ? $data["LineID"] : "-" ?></b>
                                                </p>
