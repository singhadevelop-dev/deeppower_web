...
if(isset($_POST["btnPicked"])){
    ...
    Picked = 1
    where CareerCode = :CareerCode";
    ExecuteSQL($sqlUpdate, array('CareerCode' => $_POST["btnPicked"]));
    
}

if(isset($_POST["btnDeleteRow"])){
    $sql = "delete from career where CareerCode = :CareerCode";
    ExecuteSQL($sql, array('CareerCode' => $_POST["btnDeleteRow"]));
}
    ...
    <div class="row" style="margin-bottom: 0;">
        <div class="col-sm-9">
            <h3 style="margin: 0;">
                ...
                <span class="analysis-left-menu-desc">ผู้เข้ามาสมัคร</span>
...
<div class="mat-box grey-bar">
    ...
    <a href="contact.php" class="link-history-btn">ผู้เข้ามาสมัคร</a>
    /
...
<div class="mat-box" style="border-radius: 0 0 3px 3px">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div>
                <span><b>รายการการสมัครงาน</b></span>
                ...
                <table class="jquery-datatable display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo $data["Picked"] == 1 ? "picked" : "no-picked" ?>">
                            ...
                            <td class=""><?php echo !empty($data["Position"]) ? $data["Position"] : "-" ?></td>
                                    ...
                                    <div class="modal-dialog text-left">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <!-- <div class="row">
                                                    <div class="col-md-4">ที่อยู่ตามทะเบียนบ้าน</div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <a href="<?php echo !empty($data["Image"]) ? $data["Image"] : "#" ?>" class="" target="_bank">Resume Link</a>
