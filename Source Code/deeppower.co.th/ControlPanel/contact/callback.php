                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p class="" title="Country">
                                                    <i class="fa fa-car"></i>
                                                    รุ่นรถที่สนใจ: <b class="text-primary"><?php echo $data["Type"] ?></b>
                                                </p>
                                                ...
                                                <p class="" title="วัน / เวลาที่สะดวกให้ติดต่อกลับ">
                                                    <i class="fa fa-calendar fa-fw"></i>
                                                    วัน / เวลา ที่สะดวกให้ติดต่อกลับ: <b class="text-primary"><?php echo $data["Date"] ?></b>
                                                </p>
                                                <p class="hide" title="วัน / เวลา">
                                                    <i class="fa fa-calendar fa-fw"></i>
