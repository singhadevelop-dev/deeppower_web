        ...
        foreach ($allDatas as $d) {
            ...
            if(empty($codeSub_3)){
                ...
                ExecuteSQL($sql, array(
                    ...
                    'SubCategoryCode1' => $codeSub_1,
                    'CategoryCode' => $codeCate,
                    'SubCategoryName3' => trim($d[3]),
                    'CreatedBy' => UserService::UserCode()
                ));
            ...
            if(empty($codePrd)){
                ...
                ExecuteSQL("delete from product_properties_mapping WHERE ProductCode = :ProductCode", array('ProductCode' => $codePrd));
