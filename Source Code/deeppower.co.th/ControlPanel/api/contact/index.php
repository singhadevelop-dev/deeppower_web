...
function ContactMemberCreate($data)
{
    ...
    $sql = "insert into member(MemberCode,MemberType,MemberName,MemberName2, Email,Phone,Subject,Company,LineID,Address,Message,Gender,Picked,CreatedOn) 
    values (:memberCode,
            'CONTACT',
            :name1,
            :name2,
...
function RegisterMemberContact($data)
{
    ...
    $sql = "insert into member(MemberCode,MemberType,MemberName,MemberName2, Email,Phone,Subject,Message,Company,Picked,CreatedOn
