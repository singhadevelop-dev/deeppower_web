                                    ...
                                    <div class="tab-pane active" id="link" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <?php
                                                ...
                                                $watermarks = glob($waterdir.'*.{gif,jpg,png,svg,webp}', GLOB_BRACE);
                                                ...
                                                if (qrcdr()->getConfig('uploader') == true || $count > 0) {
                                                    ...
                                                    foreach ($watermarks as $key => $water) {
                                                        ...
                                                        $listwatermarks .= '<input id="water_'.$key.'" type="hidden" name="optionlogo" value="'.$watervalue.'"';
                                                        // if ($optionlogo == $watervalue) $listwatermarks .= ' checked';
                                                        $listwatermarks .= ' checked id="optionlogo'.$key.'" class="btn-check">';
                                                        $listwatermarks .= '<label for="water_'.$key.'" class="btn btn-light hide"><img alt="'.$altImg.'" src="'.$water.'"></label>';
                                                    }
                                            ?>
